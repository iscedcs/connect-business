	...
	return (
		<Fragment>
			<div className='flex items-center justify-between'>
				<div className='font-bold uppercase'>Appointment</div>
				<div className=''>This Week</div>
			</div>
			<div className='min-h-32 w-full min-w-[200px] bg-gray-50 rounded-2xl'>
				<div className='w-[744px] h-80 relative overflow-hidden rounded-2xl bg-gray-100/[0.32]'>
