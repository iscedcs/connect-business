...
export default function ProfileAbout() {
				...
				<Fragment>
					...
					<div className='flex flex-col px-10 py-20 gap-10'>
						...
						<p className='flex-grow-0 flex-shrink-0 w-full text-base text-left text-black'>
							Event planning involves the process of
							organizing and coordinating various elements
							to create a successful event. This could
							include social gatherings, corporate
							conferences, weddings, trade shows, or any
							other type of event. The goal of event
							planning is to ensure that all aspects, such
							as venue selection, budgeting, logistics,
							catering, entertainment, and marketing, are
							carefully managed to meet the objectives and
							expectations of the event.
						</p>
						<div className='flex-grow-0 flex-shrink-0 w-full flex gap-10'>
			...
			layout = (
				...
				<Fragment>
					...
					<div className='flex flex-col items-center justify-center mt-[180px] text-center px-10 py-20 gap-10'>
						...
						<div className='flex-grow-0 flex-shrink-0 w-full justify-center flex flex-wrap gap-10'>
							<div className='w-72 h-96 overflow-hidden rounded-3xl flex-grow-0 flex-shrink-0'>
								<BlurImage
									src='/img/about-4.jpg'
									className='w-72 h-96 rounded-3xl object-cover'
									alt='About 1'
	...
	return (
		<div className='w-full h-full relative overflow-hidden rounded-2xl transition-all duration-1000'>
			{layout}
		</div>
	);
}
